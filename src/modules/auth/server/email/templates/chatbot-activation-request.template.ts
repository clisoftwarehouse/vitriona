...
export function chatbotActivationRequestEmailTemplate(params: ChatbotActivationRequestTemplateParams): string {
  ...
  return renderEmailShell({
    title: 'Activacion de Chatbot IA',
    eyebrow: 'Revision administrativa',
    preheader: `${params.businessName} solicito activar ${planLabel}`,
    contentHtml: `
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr><td align="center" style="padding:0 0 10px;"><a href="${params.approveUrl}" style="display:inline-block;background:${emailBrandStyles.primary};color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;padding:12px 34px;border-radius:10px;">Aprobar y activar chatbot</a></td></tr>
