...
ALTER TABLE "chatbot_activation_requests" ADD CONSTRAINT "chatbot_activation_requests_business_id_businesses_id_fk" FOREIGN KEY ("business_id") REFERENCES "public"."businesses"("id") ON DELETE cascade ON UPDATE no action;